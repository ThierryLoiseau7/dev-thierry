...
export const FORMATIONS: Formation[] = [
  ...
  // Web Dev
  {
    id: "ai-automatisation",
    title: "AI pour Automatiser mes Taches",
    description:
      "Automatise tes taches repetitives avec l'IA. Workflows intelligents, scripts no-code/low-code, et outils comme Zapier, Make et les agents IA pour gagner des heures chaque semaine.",
    icon: "⚙️",
    level: "Tous niveaux",
    topics: ["Zapier", "Make", "Agents IA", "Workflows", "No-Code"],
    category: "ia",
    modules: 8,
    duration: "5h",
    isNew: true,
  ...
  {
    id: "ai-marketing",
    title: "AI pour Digital Marketing",
    description:
      "Utilise l'IA pour creer du contenu, gerer tes reseaux sociaux, optimiser tes campagnes et analyser tes performances. Marketing digital augmente par l'intelligence artificielle.",
    icon: "📣",
    level: "Tous niveaux",
    topics: ["Content IA", "SEO", "Reseaux sociaux", "Campagnes", "Analytics"],
    category: "ia",
    modules: 9,
    duration: "6h",
  },
  ...
  {
    id: "ai-nodejs",
    title: "AI pour Node JS",
    description:
      "Construis des APIs et applications backend puissantes avec Node.js et l'IA. Integre des modeles de langage, automatise des processus serveur et deploie des solutions intelligentes.",
    icon: "🟢",
    level: "Intermediaire",
    topics: ["Node.js", "Express", "APIs IA", "LLM Integration", "Deploy"],
    category: "webdev",
    modules: 10,
    duration: "7h",
  },
  ...
  {
    id: "ai-smartcontrat",
    title: "AI pour Creer Smart Contrat",
    description:
      "Utilise l'IA pour ecrire, auditer et deployer des smart contracts Solidity sur Ethereum. De la generation de code a la securisation, l'IA accelere tout le workflow Web3.",
    icon: "📜",
    level: "Intermediaire",
    topics: ["Solidity", "IA + Web3", "Audit IA", "Deploy", "ERC-20/721"],
    category: "web3",
    modules: 10,
    duration: "7h",
    isNew: true,
...
export const MEMBERSHIP_PLANS: MembershipPlan[] = [
  {
    ...
    highlight: false,
    features: [
      { text: "Meeting 1h de presentation de la plateforme", included: true },
      { text: "Acces au canal Telegram", included: true },
      { text: "Consultation gratuite de 10 min (max)", included: true },
      { text: "Formations completes", included: false },
      { text: "Futures formations a vie", included: false },
  ...
  },
  {
    ...
    priceMonthly: 2000,
    billedAnnually: null,
    tagline: "Tout ce qui est la et tout ce qui arrive — a vie",
    highlight: true,
    isLifetime: true,
    features: [
      { text: "Toutes les formations actuelles incluses", included: true },
      { text: "Toutes les futures formations a vie", included: true },
      { text: "Canal Telegram communaute", included: true },
      { text: "Sessions live coding", included: true },
      { text: "Ressources telechargeable", included: true },
      { text: "Consultation 1-on-1 prioritaire", included: true },
    ],
    cta: "Obtenir l'acces a vie",
  },
];
