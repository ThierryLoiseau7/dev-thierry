  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", background: "#0f0f13", display: "flex", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", bottom: "-100px", right: "-100px", width: "450px", height: "450px", borderRadius: "50%", background: "radial-gradient(circle, rgba(0,180,100,0.18), transparent 65%)" }} />
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "56px 64px 56px 24px" }}>
          ...
          <span style={{ fontSize: 20, color: "rgba(255,255,255,0.5)", lineHeight: 1.45, marginBottom: 32, maxWidth: 480 }}>
            Scanne n&apos;importe quel memecoin. Market cap, liquidité, holders — détecte les arnaques avant d&apos;investir.
          </span>

          {/* Tags */}
          <div style={{ display: "flex", gap: 10, marginBottom: 32 }}>
            {["Market Cap", "Liquidité", "Holders", "Sécurité"].map((tag) => (
