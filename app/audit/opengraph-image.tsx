  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", background: "#0f0f13", display: "flex", position: "relative", overflow: "hidden" }}>
        {/* Glows */}
        <div style={{ position: "absolute", top: "-120px", left: "-120px", width: "500px", height: "500px", borderRadius: "50%", background: "radial-gradient(circle, rgba(0,212,255,0.18), transparent 65%)" }} />
        <div style={{ position: "absolute", bottom: "-100px", right: "-100px", width: "450px", height: "450px", borderRadius: "50%", background: "radial-gradient(circle, rgba(124,58,237,0.2), transparent 65%)" }} />
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "56px 64px 56px 24px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 28 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 16px", background: "rgba(0,212,255,0.08)", borderRadius: 100, border: "1px solid rgba(0,212,255,0.22)" }}>
              <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#00d4ff" }} />
              <span style={{ fontSize: 12, color: "#00d4ff", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase" }}>Outil gratuit</span>
            </div>
          </div>
          ...
          <span style={{ fontSize: 20, color: "rgba(255,255,255,0.5)", lineHeight: 1.45, marginBottom: 32, maxWidth: 480 }}>
            Décris ton idée — l&apos;IA analyse ta stack, budget, timeline et les services dont tu as besoin.
          </span>

          {/* Tags */}
          <div style={{ display: "flex", gap: 10, marginBottom: 32 }}>
            {["Stack", "Budget", "Timeline", "Services"].map((tag) => (
